...
system_prop = {'Accuracy': {'value': 0.5, 'unit': '%'},
               'ActuationRange': 'none',
               'DetectionLimit': {'value': 3, 'unit': 'ft'},
               'Drift': 'none',
               'Frequency': {'value': 6, 'unit': 's'},
               'Latency': {'value': 50, 'unit': 'ms'},
               'MeasurementRange': {'value': '0-3', 'unit': 'ft'},
               'Precision': {'value': 0.03, 'unit': 'in'},
               'Resolution': {'value': 0.009, 'unit': 'in'},
...
topic = "/oneM2M/req/Drenaje2/in-cse/json"
payload_lista = []
payload1 = """{"m2m:rqp": {"m2m:fr": "Drenaje2","m2m:to": "/in-cse","m2m:op": 2,"m2m:rqi": 123456}}"""
# Payload de prueba
...
"m2m:ae": {
     "api": "app-sensor",
     "rr": "false",
     "lbl": ["Type/sensor", "Category/level", "Location/SJcamara1", "Model/WL-705-003", "Unit/ft"],
     "rn": "Drenaje2"}},
"m2m:ty": 2}}"""
...
payload3="""{"m2m:rqp": {
"m2m:fr" : """+authenticate+""",
"m2m:to" : "/in-cse/in-name/Drenaje2",
"m2m:op" : 1,
"m2m:rqi": 123456,
...
payload6="""{"m2m:rqp": {
"m2m:fr" : """+authenticate+""",
"m2m:to" : "/in-cse/in-name/Drenaje2/DATA",
"m2m:op" : 1,
"m2m:rqi": 123454,
"m2m:pc": {
   "m2m:cin": {"cnf":"message",
...
payload7 = """{"m2m:rqp": {
"m2m:fr" : """+authenticate+""",
"m2m:to" : "/in-cse/in-name/Drenaje2/Healthcheck",
"m2m:op" : 1,
"m2m:rqi": 123454,
"m2m:pc": {
   "m2m:cin": {"cnf":"message",
...
payload9 = """{"m2m:rqp": {
"m2m:fr" : """+authenticate+""",
"m2m:to" : "/in-cse/in-name/Drenaje2/System_Properties",
"m2m:op" : 1,
"m2m:rqi": 123454,
"m2m:pc": {
   "m2m:cin": {"cnf":"message",
...
payload10 = """{"m2m:rqp": {
"m2m:fr" : """+authenticate+""",
"m2m:to" : "/in-cse/in-name/Drenaje2/QoS",
"m2m:op" : 1,
"m2m:rqi": 123454,
"m2m:pc": {
   "m2m:cin": {"cnf":"message",
...
while True:
    for payload in payload_lista:
        ...
        client.loop_start()
        client.subscribe("/oneM2M/resp/in-cse/Drenaje2/json")
