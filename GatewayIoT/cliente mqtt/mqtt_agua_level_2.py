...
system_prop = {'Accuracy': {'value': 0.1, 'unit': '%'},
               'ActuationRange': 'None',
               'DetectionLimit': {'value': 15, 'unit': 'ft'},
               'Drift': 'None',
               'Frequency': {'value': 10, 'unit': 's'},
               'Latency': "None",
               'MeasurementRange': {'value': '0-15', 'unit': 'ft'},
               'Precision': {'value': 0.01, 'unit': 'in'},
               'Resolution': {'value': 0.006, 'unit': 'in'},
               'ResponseTime': {'value': 25, 'unit': 'ms'},
...
topic = "/oneM2M/req/park_drain2/mn-cse/json"
payload_lista = []
payload1 = """{"m2m:rqp": {"m2m:fr": "park_drain2","m2m:to": "/mn-cse","m2m:op": 2,"m2m:rqi": 123456}}"""
# Payload de prueba
...
"m2m:ae": {
     "api": "app-sensor",
     "rr": "false",
     "lbl": ["Type/sensor", "Category/level", "Location/park", "Model/WL-450-015", "Unit/ft"],
     "rn": "park_drain2"}},
"m2m:ty": 2}}"""
# payload para crear la aplicacion con el nombre park_drain2

payload3="""{"m2m:rqp": {
"m2m:fr" : """+authenticate+""",
"m2m:to" : "/mn-cse/mn-name/park_drain2",
"m2m:op" : 1,
"m2m:rqi": 123456,
...
payload6="""{"m2m:rqp": {
"m2m:fr" : """+authenticate+""",
"m2m:to" : "/mn-cse/mn-name/park_drain2/DATA",
"m2m:op" : 1,
"m2m:rqi": 123454,
"m2m:pc": {
   "m2m:cin": {"cnf":"message",
...
payload7 = """{"m2m:rqp": {
"m2m:fr" : """+authenticate+""",
"m2m:to" : "/mn-cse/mn-name/park_drain2/Healthcheck",
"m2m:op" : 1,
"m2m:rqi": 123454,
"m2m:pc": {
   "m2m:cin": {"cnf":"message",
...
payload9 = """{"m2m:rqp": {
"m2m:fr" : """+authenticate+""",
"m2m:to" : "/mn-cse/mn-name/park_drain2/System_Properties",
"m2m:op" : 1,
"m2m:rqi": 123454,
"m2m:pc": {
   "m2m:cin": {"cnf":"message",
...
payload10 = """{"m2m:rqp": {
"m2m:fr" : """+authenticate+""",
"m2m:to" : "/mn-cse/mn-name/park_drain2/QoS",
"m2m:op" : 1,
"m2m:rqi": 123454,
"m2m:pc": {
   "m2m:cin": {"cnf":"message",
...
for payload in payload_lista:
    ...
    client.loop_start()
    client.subscribe("/oneM2M/resp/mn-cse/park_drain2/json")
