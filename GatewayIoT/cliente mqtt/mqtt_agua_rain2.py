...
system_prop = {"Accuracy": {"value": 1, "unit": "%"},
               "ActuationRange": "None",
               "DetectionLimit": {"value": 0.01, "unit": "in"},
               "Drift": "None",
               "Frequency": {"value": 3, "unit": "s"},
...
topic = "/oneM2M/req/park_rain2/in-cse/json"
payload_lista = []
payload1 = """{"m2m:rqp": {"m2m:fr": "park_rain2","m2m:to": "/in-cse","m2m:op": 2,"m2m:rqi": 123456}}"""
# Payload de prueba
...
"m2m:ae": {
     "api": "app-sensor",
     "rr": "false",
     "lbl": ["Type/sensor", "Category/rain", "Location/park", "Model/RG-600", "Unit/in"],
     "rn": "park_rain2"}},
"m2m:ty": 2}}"""
# payload para crear la aplicacion con el nombre park_rain2

payload3="""{"m2m:rqp": {
"m2m:fr" : """+authenticate+""",
"m2m:to" : "/in-cse/in-name/park_rain2",
"m2m:op" : 1,
"m2m:rqi": 123456,
...
payload6="""{"m2m:rqp": {
"m2m:fr" : """+authenticate+""",
"m2m:to" : "/in-cse/in-name/park_rain2/DATA",
"m2m:op" : 1,
"m2m:rqi": 123454,
"m2m:pc": {
   "m2m:cin": {"cnf":"message",
...
payload7 = """{"m2m:rqp": {
"m2m:fr" : """+authenticate+""",
"m2m:to" : "/in-cse/in-name/park_rain2/Healthcheck",
"m2m:op" : 1,
"m2m:rqi": 123454,
"m2m:pc": {
   "m2m:cin": {"cnf":"message",
...
payload9 = """{"m2m:rqp": {
"m2m:fr" : """+authenticate+""",
"m2m:to" : "/in-cse/in-name/park_rain2/System_Properties",
"m2m:op" : 1,
"m2m:rqi": 123454,
"m2m:pc": {
   "m2m:cin": {"cnf":"message",
...
payload10 = """{"m2m:rqp": {
"m2m:fr" : """+authenticate+""",
"m2m:to" : "/in-cse/in-name/park_rain2/QoS",
"m2m:op" : 1,
"m2m:rqi": 123454,
"m2m:pc": {
   "m2m:cin": {"cnf":"message",
...
while True:
    for payload in payload_lista:
        ...
        client.loop_start()
        client.subscribe("/oneM2M/resp/in-cse/park_rain2/json")
