...
QoS = {"Availability": {"value": round(random.random(), 2), "unit": "%"}, "Capacity": "TBD",
       'Cost': {"value": [random.randint(0, 1000), random.randint(0, 1000)], "unit": random.choice(unit_coin)},
...
system_prop = {"Accuracy": {"value": [3, 4], "unit": "%"},
               # "ActuationRange": "None",
...
topic = "/oneM2M/req/park_rain3/in-cse/json"
payload_lista = []
payload1 = """{"m2m:rqp": {"m2m:fr": "park_rain3","m2m:to": "/in-cse","m2m:op": 2,"m2m:rqi": 123456}}"""
# Payload de prueba

# "lbl": ["Type/sensor", "Category/rain", "Location/park", "Model/RG-100", "Unit/in"],
...
"m2m:ae": {
     "api": "app-sensor",
     "rr": "false",
     "lbl": ["Type/sensor", "Location/park", "Model/RG-100"],
     "rn": "park_rain3"}},
"m2m:ty": 2}}"""
# payload para crear la aplicacion con el nombre park_rain3

payload3="""{"m2m:rqp": {
"m2m:fr" : """+authenticate+""",
"m2m:to" : "/in-cse/in-name/park_rain3",
"m2m:op" : 1,
"m2m:rqi": 123456,
...
payload6="""{"m2m:rqp": {
"m2m:fr" : """+authenticate+""",
"m2m:to" : "/in-cse/in-name/park_rain3/DATA",
"m2m:op" : 1,
"m2m:rqi": 123454,
"m2m:pc": {
   "m2m:cin": {"cnf":"message",
...
payload7 = """{"m2m:rqp": {
"m2m:fr" : """+authenticate+""",
"m2m:to" : "/in-cse/in-name/park_rain3/Healthcheck",
"m2m:op" : 1,
"m2m:rqi": 123454,
"m2m:pc": {
   "m2m:cin": {"cnf":"message",
...
payload9 = """{"m2m:rqp": {
"m2m:fr" : """+authenticate+""",
"m2m:to" : "/in-cse/in-name/park_rain3/System_Properties",
"m2m:op" : 1,
"m2m:rqi": 123454,
"m2m:pc": {
   "m2m:cin": {"cnf":"message",
...
payload10 = """{"m2m:rqp": {
"m2m:fr" : """+authenticate+""",
"m2m:to" : "/in-cse/in-name/park_rain3/QoS",
"m2m:op" : 1,
"m2m:rqi": 123454,
"m2m:pc": {
   "m2m:cin": {"cnf":"message",
...
for payload in payload_lista:
    ...
    client.loop_start()
    client.subscribe("/oneM2M/resp/in-cse/park_rain3/json")
