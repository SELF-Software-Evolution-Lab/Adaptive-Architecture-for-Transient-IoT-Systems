...
for j in range(1):
    ...
    name = random.choice(["WQ-Cond-1"])
    # Service_name = str(uuid.uuid4())
    location = random.choice(["ML"])
    category = random.choice(["Conductivity"])
    unit_time = ["s", "hr"]
    unit = ["uS/cm"]
    unit_coin = ["USD", "COL"]
    binary = [True, False]
    ...
    functional_prop = {'Base URL': 'http://192.168.0.7:8080/~', 'Relative URL': '/in-cse/in-name/'+name,
                       ...
                       "System property": {"Accuracy": {"value": 0.5, "unit": "%"},
                                           "ActuationRange": "none",
                                           "DetectionLimit": {"value": 200, "unit": "uS/cm"},
                                           "Drift": "none",
                                           "Frequency": {"value": 6, "unit": "s"},
                                           "Latency": {"value": 1, "unit": "s"},
                                           "MeasurementRange": {"value": "0-200", "unit": "uS/cm"},
                                           "Precision": {"value": 0.1, "unit": "uS/cm"},
                                           "Resolution": {"value": 0.1, "unit": "uS/cm"},
