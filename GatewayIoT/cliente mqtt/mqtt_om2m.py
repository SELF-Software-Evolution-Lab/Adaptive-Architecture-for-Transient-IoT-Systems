...
topic = "/oneM2M/req/Drenaje1/in-cse/json"
payload_lista = []
payload1 = """{"m2m:rqp": {"m2m:fr": "Drenaje1","m2m:to": "/in-cse","m2m:op": 2,"m2m:rqi": 123456}}"""
# Payload de prubea
...
"m2m:ae": {
     "api": "app-sensor",
     "rr": "false",
     "lbl": ["Type/sensor", "Category/level", "Location/home", "Model/WL-705-003"],
     "rn": "Drenaje1"}},
"m2m:ty": 2}}"""
# payload para crear la aplicacion con el nombre Drenaje1

payload3="""{"m2m:rqp": {
"m2m:fr" : """+authenticate+""",
"m2m:to" : "/in-cse/in-name/Drenaje1",
"m2m:op" : 1,
"m2m:rqi": 123456,
...
payload6="""{"m2m:rqp": {
"m2m:fr" : """+authenticate+""",
"m2m:to" : "/in-cse/in-name/Drenaje1/DATA",
"m2m:op" : 1,
"m2m:rqi": 123454,
"m2m:pc": {
   "m2m:cin": {"cnf":"message",
...
payload7="""{"m2m:rqp": {
"m2m:fr" : """+authenticate+""",
"m2m:to" : "/in-cse/in-name/Drenaje1/Healthcheck",
"m2m:op" : 1,
"m2m:rqi": 123454,
"m2m:pc": {
   "m2m:cin": {"cnf":"message",
...
for payload in payload_lista:
    ...
    client.connect("18.188.209.203", 1883)

    client.loop_start()
    client.subscribe("/oneM2M/resp/in-cse/Drenaje1/json")
