...
topic="/oneM2M/req/Temp_cocina/mn-cse/json"
payload_lista=[]
payload1="""{"m2m:rqp": {"m2m:fr": "Temp_cocina","m2m:to": "/mn-cse","m2m:op": 2,"m2m:rqi": 123456}}"""
...
# payload3="""{"m2m:rqp": {
# "m2m:fr" : "admin:admin",
# "m2m:to" : "/mn-cse/mn-name/Temp_cocina",
# "m2m:op" : 1,
# "m2m:rqi": 123456,
...
payload6="""{"m2m:rqp": {
"m2m:fr" : "admin:admin",
"m2m:to" : "/mn-cse/mn-name/Temp_cocina/DATA",
"m2m:op" : 1,
"m2m:rqi": 123454,
"m2m:pc": {
   "m2m:cin": {"cnf":"message",
...
payload7="""{"m2m:rqp": {
"m2m:fr" : "admin:admin",
"m2m:to" : "/mn-cse/mn-name/Temp_cocina/Healthcheck",
"m2m:op" : 1,
"m2m:rqi": 123454,
"m2m:pc": {
   "m2m:cin": {"cnf":"message",
...
for payload in payload_lista:
    ...
    client.loop_start()
    client.subscribe("/oneM2M/resp/mn-cse/Temp_cocina/json")
