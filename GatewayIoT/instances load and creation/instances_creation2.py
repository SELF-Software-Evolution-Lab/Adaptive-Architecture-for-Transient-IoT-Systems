...
for i in range(1, 2501):
    ...
    new_app["App Name"] = "Sensor_gd" + str(i)

    # enter username and password
    authenticate = """ "admin:admin" """
    topic = "/oneM2M/req/" + new_app["App Name"] + "/mn-cse/json"
    payload_lista = []
    payload1 = """{"m2m:rqp": {"m2m:fr": '""" + new_app["App Name"] + """', 
    "m2m:to": "/mn-cse","m2m:op": 2,"m2m:rqi": 123456}}"""
    # Payload de prueba
    ...
    payload3="""{"m2m:rqp": {
    "m2m:fr" : """+authenticate+""",
    "m2m:to" : "/mn-cse/mn-name/""" + new_app["App Name"] + """",
    "m2m:op" : 1,
    "m2m:rqi": 123456,
    ...
    payload6 = """{"m2m:rqp": {
    "m2m:fr" : """+authenticate+""",
    "m2m:to" : "/mn-cse/mn-name/""" + new_app["App Name"] + """/DATA",
    "m2m:op" : 1,
    "m2m:rqi": 123454,
    "m2m:pc": {
       "m2m:cin": {"cnf":"message",
    ...
    payload7 = """{"m2m:rqp": {
    "m2m:fr" : """+authenticate+""",
    "m2m:to" : "/mn-cse/mn-name/""" + new_app["App Name"] + """/Healthcheck",
    "m2m:op" : 1,
    "m2m:rqi": 123454,
    "m2m:pc": {
       "m2m:cin": {"cnf":"message",
    ...
    payload9 = """{"m2m:rqp": {
    "m2m:fr" : """+authenticate+""",
    "m2m:to" : "/mn-cse/mn-name/""" + new_app["App Name"] + """/System_Properties",
    "m2m:op" : 1,
    "m2m:rqi": 123454,
    "m2m:pc": {
       "m2m:cin": {"cnf":"message",
    ...
    payload10 = """{"m2m:rqp": {
    "m2m:fr" : """+authenticate+""",
    "m2m:to" : "/mn-cse/mn-name/""" + new_app["App Name"] + """/QoS",
    "m2m:op" : 1,
    "m2m:rqi": 123454,
    "m2m:pc": {
       "m2m:cin": {"cnf":"message",
    ...
    for payload in payload_lista:
        client.subscribe("/oneM2M/resp/mn-cse/" + new_app["App Name"] + "/json")
